...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnStampa = ft.ElevatedButton(text = "Analisi Componente.",
                                                 on_click=self._controller.handleStampa)

        row2 = ft.Row([
            ft.Container(self._ddAlbum, width=300),
            ft.Container(self._btnStampa, width=300)
        ], alignment=ft.MainAxisAlignment.CENTER)
        self._page.controls.append(row2)

        #ROW3
        self._ddAlbum2 = ft.Dropdown(label="Album")
        self._btnPercorso = ft.ElevatedButton(text="Set di Album",
                                               on_click=self._controller.handlePercorso)
        row3 = ft.Row([
            ft.Container(self._ddAlbum2, width=300),
